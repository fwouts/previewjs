...
class InlayProviderFactory : InlayHintsProviderFactory {
    companion object {
        // Note: "textmate" is what's used in IntelliJ CE for JS/TS(X) files.
        val LANGUAGE_IDS = setOf("textmate", "ECMAScript 6", "JavaScript", "TypeScript", "TypeScript JSX", "SvelteHTML", "VueJS")
