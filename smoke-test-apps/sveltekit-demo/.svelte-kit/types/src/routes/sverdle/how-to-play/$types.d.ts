...
export type PageData = Expand<Omit<PageParentData, keyof PageParentData & EnsureDefined<PageServerData>> & EnsureDefined<PageParentData & EnsureDefined<PageServerData>>>;