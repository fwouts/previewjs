...
pnpm --filter "!./dev-workspace" --filter "!./frameworks/**/*" -r update !env-paths !get-port !globby !execa !inquirer !@types/inquirer !@types/vscode !vite-tsconfig-paths "!@previewjs/*" !turbo --latest
