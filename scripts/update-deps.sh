...
pnpm --filter "!./dev-workspace" --filter "!./frameworks/**/*" -r update !env-paths !get-port !execa !inquirer !@types/inquirer !@types/vscode !vite-tsconfig-paths "!@previewjs/*" --latest
