...
// TODO: Write this test (app behaviour currently broken).
...
export const storiesTests = testSuite("stories", (test) => {
  test("shows multiple components", "react", async ({ appDir, controller }) => {
